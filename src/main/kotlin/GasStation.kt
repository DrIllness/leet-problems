...
fun main() {
    ...
    println(canCompleteCircuit(intArrayOf(5,1,2,3,4), intArrayOf(4,4,1,5,1)))
    println(canCompleteCircuit(intArrayOf(5,8,2,8), intArrayOf(6,5,6,6)))
}
